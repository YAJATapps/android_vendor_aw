...
ifeq (A20, $(SW_CHIP_PLATFORM))
    ...
    ifeq (,$(filter-out 4.4%,$(PLATFORM_VERSION)))
        ...
        LOCAL_JAVA_LIBRARIES:= org.apache.http.legacy.boot
        DRAGONBOX_STATIC_JAVA_LIBRARIES := services.core  libsystemmix
    endif
    ...
    ifeq (,$(filter-out 11%,$(PLATFORM_VERSION)))
        ...
        LOCAL_JAVA_LIBRARIES:= org.apache.http.legacy
        DRAGONBOX_STATIC_JAVA_LIBRARIES := services.core  libsystemmix softwinner.display.output
    endif
...
ifneq ($(DRAGONBOX_SRC_FILES),)
    ...
    LOCAL_JAVA_LIBRARIES:= org.apache.http.legacy
    LOCAL_STATIC_JAVA_LIBRARIES += services.core  libsystemmix
endif
